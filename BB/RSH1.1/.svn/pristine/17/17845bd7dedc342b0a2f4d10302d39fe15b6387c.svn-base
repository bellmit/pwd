...
import rongshanghui.tastebychance.com.rongshanghui.alibaba.openimui.sample.TribeMsgRecTypeSetActivity;
...
public class TribeInfoActivity extends Activity {
    ...
    private void initTitle() {
        ...
        titleView.setBackgroundColor(Color.parseColor("#25498F"));
