...
import rongshanghui.tastebychance.com.rongshanghui.alibaba.openimui.contact.FindContactActivity;
...
public class ContactsUICustomSample extends IMContactsUI {
    ...
    public View getCustomTitle(final Fragment fragment, final Context context, LayoutInflater inflater) {
        ...
        backButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View arg0) {
                EventBusUtils.post(new EventToConversation());
...
//        backButton.setVisibility(View.GONE);
    ...
    private void ShowAddContactDialog(final Activity activity) {
        ...
        mUserId.setText("");
        mAppKey.setText(Constants.APP_KEY);
        AlertDialog dialog = new YWAlertDialog.Builder(activity)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        contactService.addContact(userId, appKey, "", "", new IWxCallback() {//发起好友添加
                            @Override
                            ...
                            public void onError(int code, String info) {
                                ToastUtils.showOneToast(MyApplication.getAppContext(), "添加失败，请重新添加");
                            }
