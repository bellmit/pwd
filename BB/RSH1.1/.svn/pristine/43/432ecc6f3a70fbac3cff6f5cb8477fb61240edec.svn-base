...
import rongshanghui.tastebychance.com.rongshanghui.util.AppException;
import rongshanghui.tastebychance.com.rongshanghui.view.CustomProgressDialog;
import rongshanghui.tastebychance.com.rongshanghui.view.LoadingDialog;
...
public abstract class BaseFragmentActivity extends FragmentActivity implements
    ...
    private static class MyHandler<T extends Activity> extends Handler {
        ...
        public void handleMessage(@NonNull Message msg) {
            final T t = mT.get();
            if (null != t) {
                ((BaseFragmentActivity) t).processMessage(msg);
            }
        }
    }
