...
public class DateTimePickDialogUtil implements OnDateChangedListener,
    ...
    public void init(DatePicker datePicker, TimePicker timePicker) {
        ...
        datePicker.init(calendar.get(Calendar.YEAR),
                Integer.parseInt(DateUtil.getDayFormatString(calendar.get(Calendar.MONTH))),
...
//						inputDate.setText("");
    ...
    public void onDateChanged(DatePicker view, int year, int monthOfYear,
        ...
        calendar.set(datePicker.getYear(), Integer.parseInt(DateUtil.getDayFormatString(datePicker.getMonth())),
    ...
    private Calendar getCalendarByInintData(String initDateTime) {
        ...
        calendar.set(currentYear, Integer.parseInt(DateUtil.getDayFormatString(currentMonth)), currentDay, currentHour,
                currentMinute);
        return calendar;
    }
