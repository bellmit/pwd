                        ...
                        case Constants.WHAT_GETDATA:
                            ...
                            if (null != resInfo) {
                                if (((CLXZActivity) t).pageIndex > Constants.PAGE_START_INDEX && resInfo.getClass(ZNCKBean.class).getData().size() == 0) {
                                    ToastUtils.showOneToast(((CLXZActivity) t).getApplicationContext(), "没有更多");
                                    emptyLayoutShowOrHide(((CLXZActivity) t).emptyLayout, false);
                                    return;
                                }
                                ...
                                protected void convert(final ViewHolder viewHolder, final DownloadCKBean.DataBean item) {
                                    ...
                                    rl.setOnClickListener(new NoDoubleClickListener() {
                                        ...
                                        public void onNoDoubleClick(View v) {
                                            DialogUtils.getInstance().AlertMessage(t, null, "确定下载该文档？"
                                                            ...
                                                            OkGo.get(url)//
                                                                    ...
                                                                    .execute(new FileCallback(finalDestFileDir, item.getPost_title()) {  //文件下载时，可以指定下载的文件目录和文件名
                                                                        ...
                                                                        public void onSuccess(File file, Call call, Response response) {
                                                                            ...
                                                                            ToastUtils.showOneToast(t.getApplicationContext(), "文件保存在:" + finalDestFileDir + item.getPost_title());
                                                                            if (null != progressTv) {
