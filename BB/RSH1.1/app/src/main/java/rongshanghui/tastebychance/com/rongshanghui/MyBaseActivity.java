        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if (null != t) {
                try {
                    switch (msg.what) {
                        case ERROR_WHAT:
                            ToastUtils.showOneToast(((MyBaseActivity) t).getApplicationContext(), (String) msg.obj);
                            break;
                        case INFO_WHAT:
                            ...
                            break;
                        case LOADING_CANCEL:
                            if (null != ((MyBaseActivity) t).loadingBar) {
                                ((MyBaseActivity) t).loadingBar.cancel();
                                ((MyBaseActivity) t).loadingBar = null;
                            }
                            break;
                        default:
                            break;
