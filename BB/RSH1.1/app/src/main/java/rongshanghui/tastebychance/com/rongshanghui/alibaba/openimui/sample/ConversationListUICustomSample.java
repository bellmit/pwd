...
/**
 * 类描述：最近会话界面的定制点(根据需要实现相应的接口来达到自定义会话列表界面)，不设置则使用openIM默认的实现
 ...
 * 创建时间： 2017/12/20 9:07
 * 修改人：
 * 修改时间：2017/12/20 9:07
 * 修改备注：
 *
 * @version 1.0
 */
public class ConversationListUICustomSample extends IMConversationListUI {
    ...
    public View getCustomConversationListTitle(final Fragment fragment, final Context context, LayoutInflater inflater) {
        ...
        RelativeLayout customView = (RelativeLayout) inflater
                .inflate(R.layout.head_custom_conversation_title_bar, new RelativeLayout(context), false);
        customView.setBackgroundColor(Color.parseColor("#25498F"));
...
//        title.setText(mIMKit.getIMCore().getShowName());
        ...
        /*if (TextUtils.isEmpty(loginUserId) || TextUtils.isEmpty(Constants.APP_KEY)){
            title.setText("未登录");
        }
        title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(loginUserId) || TextUtils.isEmpty(Constants.APP_KEY)){
                    ToastUtils.showOneToast(context, "click");
                }else{
                    ToastUtils.showOneToast(context, "click ("+" userid = "+ loginUserId+" ,appKey = "+ Constants.APP_KEY+" )");
                }
            }
        });*/
        ...
        rightButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //联系人
                EventBusUtils.post(new EventToContactList());
            }
        });
        return customView;
    }
    ...
    public void setCustomTitleProgressBar(Fragment fragment, View mCustomTitleView, boolean isVisible) {
        super.setCustomTitleProgressBar(fragment, mCustomTitleView, isVisible);
    }
    ...
    /**
     * 获取自定义会话要展示的自定义view，该方法的实现类完全类似于BaseAdapter中getView()方法实现
     *
     * @param context
     * @param conversation
     * @param convertView
