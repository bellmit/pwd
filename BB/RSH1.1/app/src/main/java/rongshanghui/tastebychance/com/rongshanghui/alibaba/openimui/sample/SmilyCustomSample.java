...
public class SmilyCustomSample {
     ...
     *
     * @param smileyResArray  表情资源数组
     * @param horizontalCount 水平展示个数
     * @param verticalCount   垂直展示个数
     *                        <br>
     ...
     *
     * @param smileyResArray drawable资源id数组
     ...
     * @param shortCuts       快捷方式数组
     * @param meanings        含义数组
     * @param horizontalCount 水平方向上的展示个数
     * @param verticalCount   垂直方向上的展示个数
     *                        <p>
     *                        <br>
     *                        注:该方法添加的表情属于自定义Emoji表情,填加后的展示需要开发者自己考虑多端解析的实现
     */
