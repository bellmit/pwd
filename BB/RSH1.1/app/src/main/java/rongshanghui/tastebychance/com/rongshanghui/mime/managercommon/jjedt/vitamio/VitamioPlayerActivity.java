package rongshanghui.tastebychance.com.rongshanghui.mime.managercommon.jjedt.vitamio;
...
public class VitamioPlayerActivity extends AppCompatActivity implements MediaPlayer.OnInfoListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //获得当前窗体对象
        Window window = VitamioPlayerActivity.this.getWindow();
        //设置当前窗体为全屏显示
