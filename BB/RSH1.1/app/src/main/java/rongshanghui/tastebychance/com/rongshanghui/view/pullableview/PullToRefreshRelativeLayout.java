...
/**
 * 自定义的布局，用来管理三个子控件，其中一个是下拉头，一个是包含内容的pullableview（可以实现Pullable接口的任何View）
 * 还有一个上拉头，
...
public class PullToRefreshRelativeLayout extends RelativeLayout {
    ...
    public PullToRefreshRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class AutoRefreshAndLoadTask extends
        ...
        protected void onPostExecute(String result) {
            ...
            // 刷新操作
            if (mListener != null)
                mListener.onRefresh(PullToRefreshRelativeLayout.this);
            hide();
        }
    ...
    public interface OnRefreshListener {
         ...
         * 刷新操作
         */
        void onRefresh(PullToRefreshRelativeLayout pullToRefreshLayout);

        /**
         * 加载操作
         */
        void onLoadMore(PullToRefreshRelativeLayout pullToRefreshLayout);
    }
}
