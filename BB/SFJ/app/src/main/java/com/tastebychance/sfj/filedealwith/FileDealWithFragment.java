package com.tastebychance.sfj.filedealwith;
...
import com.tastebychance.sfj.filedealwith.hasbeensent.HasBenSentFragment;
import com.tastebychance.sfj.filedealwith.received.ReceivedFragment;
import com.tastebychance.sfj.filedealwith.writefile.WriteFileActivity;
 ...
 * @author shenbinghong
 * @time 2018/2/7 20:36
 * @path com.tastebychance.sfj.filedealwith.FileDealWithFragment.java
 */
public class FileDealWithFragment extends MyBaseFragment {
    ...
    private FileDealWithFragment fragment;

    private static final int PAGER_NUM = 2;

    public static FileDealWithFragment newInstance(String content) {
        Bundle arguments = new Bundle();
        arguments.putString(Constants.EXTRA_CONTENT, content);
        FileDealWithFragment homeFragment = new FileDealWithFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (rootView != null) {
            ...
            rootView = localInflater.inflate(R.layout.fragment_filedealwith, null);
    ...
    private static final String[] TITLE = new String[]{Constants.FILEDEAL_RECEIVED, Constants.FILEDEAL_HASBEENSENT};
    ...
    class TabPageIndicatorAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (position == 0){
                ...
                fragment = new HasBenSentFragment();
            }
...
//            return "";
    ...
    private void initTab(@NonNull ImageView imageView, @NonNull TextView textView) {
    ...
    private void setTitle() {
        ...
        if (headCenterTitleTv != null) {
            ...
            headCenterTitleTv.setText("文件处理");
        }
        if (null != headRightIv) {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.head_right_iv:
                getActivity().startActivity(new Intent(getActivity(), WriteFileActivity.class));
                break;
