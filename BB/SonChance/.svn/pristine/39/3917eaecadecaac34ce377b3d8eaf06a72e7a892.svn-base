...
public class PicassoUtils {
    ...
    public void loadImageByPath(Context context, String path, ImageView imageView, String bitmapShowType, float roundRadius){
        loadImageByPath(context,path,imageView,R.drawable.person_defaultheadportrait,R.drawable.person_defaultheadportrait,bitmapShowType,roundRadius);
    }
    ...
    public void loadImageById(Context context, int localimage, ImageView imageView, String bitmapShowType, float roundRadius){
        if(bitmapShowType.equals(PICASSO_BITMAP_SHOW_CIRCLE_TYPE)){
            Picasso.with(context).load(localimage).placeholder(R.drawable.person_defaultheadportrait).error(R.drawable.ic_launcher).transform(new CircleTransform()).into(imageView);
        }else if(bitmapShowType.equals(PICASSO_BITMAP_SHOW_ROUND_TYPE)){
    ...
    public void loadImageByUri(Context context, Uri uri, ImageView imageView, String bitmapShowType, float roundRadius){
        if(bitmapShowType.equals(PICASSO_BITMAP_SHOW_CIRCLE_TYPE)){
            Picasso.with(context).load(uri).placeholder(R.drawable.person_defaultheadportrait).error(R.drawable.ic_launcher).transform(new CircleTransform()).into(imageView);
        }else if(bitmapShowType.equals(PICASSO_BITMAP_SHOW_ROUND_TYPE)){
            Picasso.with(context).load(uri).transform(new RoundTransform(roundRadius)).into(imageView);
        }else {
