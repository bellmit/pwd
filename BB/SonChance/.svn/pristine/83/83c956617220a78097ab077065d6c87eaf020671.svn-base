 ...
 * 2017年8月9日
 */
public class GuideActivity extends MyBaseActivity implements ViewPager.OnPageChangeListener,View.OnClickListener{
	...
	public void intentToTabHost(View view){
		startActivity(new Intent(GuideActivity.this,TabHostMainActivity.class));
		this.finish();
	}
			...
			public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
				if (currentItem == 3){
					if ((e1.getRawX() - e2.getRawX() >= flaggingWidth)){
						Intent intent = new Intent(GuideActivity.this, TabHostMainActivity.class);
