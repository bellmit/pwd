...
import com.tastebychance.sonchance.view.NodeProgressBar;
...
public class MemberCenterActivity extends MyBaseActivity {
    ...
    private NodeProgressBar person_membercenter_nodeprogressbar;
    ...
    private void bindViews() {
        ...
        person_membercenter_nodeprogressbar = (NodeProgressBar) findViewById(R.id.person_membercenter_nodeprogressbar);
    }

    private void initObject(){
        new NodeProgressBar(MemberCenterActivity.this);
        person_membercenter_nodeprogressbar.setProgressOnly(30);
        person_membercenter_nodeprogressbar.setProgressAndIndex(20);
    }
    ...
    private void toastNoMore() {
        Toast.makeText(MemberCenterActivity.this,"没有更多了",Toast.LENGTH_SHORT).show();
    }
