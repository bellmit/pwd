...
public class SharedPreferencesUtils {
    public static String Name = "SONCHANCE";
    ...
    public static void setConfigInt(Context context, String cachName, String key, int intValue) {
        SharedPreferences share = context.getSharedPreferences(cachName, Activity.MODE_PRIVATE);
        SharedPreferences.Editor edit = share.edit();
    ...
    public static int getConfigInt(Context context, String cachName, String key) {
        SharedPreferences share = context.getSharedPreferences(cachName, Activity.MODE_PRIVATE);
