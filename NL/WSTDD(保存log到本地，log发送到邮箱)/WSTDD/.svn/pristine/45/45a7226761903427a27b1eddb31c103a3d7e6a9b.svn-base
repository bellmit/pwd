...
public class MyActivitiesListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (0==myactivityListData.getStatus()) {//状态  0.未发布 1.报名中 2.关闭报名 4.已撤销
			holder.find_hot_signstate.setText("未发布 ");
		}else if (1==myactivityListData.getStatus()) {//状态  0.未发布 1.报名中 2.关闭报名 4.已撤销
			holder.find_hot_signstate.setText("报名中");
		}else if (2==myactivityListData.getStatus()) {//状态  0.未发布 1.报名中 2.关闭报名 4.已撤销
			holder.find_hot_signstate.setText("关闭报名");
		}else if (4==myactivityListData.getStatus()) {//状态  0.未发布 1.报名中 2.关闭报名 4.已撤销
