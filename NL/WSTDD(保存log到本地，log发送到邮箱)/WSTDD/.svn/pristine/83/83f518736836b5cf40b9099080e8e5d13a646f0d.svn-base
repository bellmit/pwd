 ...
 *
 */
public class HttpMultipartPostZhiFuBaoFragment extends AsyncTask<String, Integer, String> {
	protected CustomProgressDialog progressDialog = null;
	private ZhiFuBaoFragment fragment;
	private Context context;
	private List<String> filePathList;
//	ProgressDialog pd;
	private long totalSize;

	public HttpMultipartPostZhiFuBaoFragment(Context context,ZhiFuBaoFragment fragment, List<String> filePathList) {
