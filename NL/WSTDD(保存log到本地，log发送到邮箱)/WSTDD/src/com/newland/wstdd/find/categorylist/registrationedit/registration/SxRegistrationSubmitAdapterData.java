 ...
 *
 */
public class SxRegistrationSubmitAdapterData {
	
	private String name;// 姓名
	private String phone;// 手机
	// private List<String> childString;//子listview对应的数据
	private List<Map<String, String>> map;//这个表示的最终要输入的值
	private List<Map<String, String>> inputTempList;//这个表示的暂时保存数据的内容
	private List<Map<String, String>> lastTempList;//这个表示的是保存输入之前的内容
	...
	public SxRegistrationSubmitChildAdapter getAdapter() {
		return adapter;
	}

	public void setAdapter(SxRegistrationSubmitChildAdapter adapter) {
