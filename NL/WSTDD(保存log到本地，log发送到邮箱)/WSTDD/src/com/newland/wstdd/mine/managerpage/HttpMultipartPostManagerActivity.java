 ...
 *
 */
public class HttpMultipartPostManagerActivity extends AsyncTask<String, Integer, String> {
...
//	ProgressDialog pd;
	...
	public HttpMultipartPostManagerActivity(Context context, List<String> filePathList) {
...
//		WBResponse response= MessageUtil.JsonStrToWBResponse(result,cls);
		((ManagerPageActivity)context).handleHeadImg(result);//传完之后的操作
		if(progressDialog!=null){
			progressDialog.dismiss();
		 	progressDialog=null;
		}
