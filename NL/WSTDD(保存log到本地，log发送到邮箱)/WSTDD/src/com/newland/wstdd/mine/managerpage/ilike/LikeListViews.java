...
public class LikeListViews extends ListView {

    public LikeListViews(Context context) {
        super(context);
    }
    public LikeListViews(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public LikeListViews(Context context, AttributeSet attrs, int defStyle) {
