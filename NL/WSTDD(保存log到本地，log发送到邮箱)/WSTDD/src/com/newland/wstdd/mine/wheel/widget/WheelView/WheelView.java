package com.newland.wstdd.mine.wheel.widget.WheelView;

import java.util.LinkedList;
import java.util.List;

import com.newland.wstdd.R;
import com.newland.wstdd.mine.wheel.widget.WheelView.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] {0x99EEEEEE,
			0x44EEEEEE, 0x00FFFFFF };
