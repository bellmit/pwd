 ...
 *
 */
public class SxRegistrationEditAdapterData {
	...
	public SxRegistrationEditChildAdapter getAdapter() {
		return adapter;
	}

	public void setAdapter(SxRegistrationEditChildAdapter adapter) {
