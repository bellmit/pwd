...
import com.newland.wstdd.mine.applyList.PassTYAdapter.ViewHolder;
...
public class PassTMAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		viewHolder.tuanda_iv.setImageDrawable(context.getResources().getDrawable(R.drawable.test_applylist_tm));
