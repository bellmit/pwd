...
public class SxRegistrationSubmitListViews extends ListView {

    public SxRegistrationSubmitListViews(Context context) {
        super(context);
    }
    public SxRegistrationSubmitListViews(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public SxRegistrationSubmitListViews(Context context, AttributeSet attrs, int defStyle) {
