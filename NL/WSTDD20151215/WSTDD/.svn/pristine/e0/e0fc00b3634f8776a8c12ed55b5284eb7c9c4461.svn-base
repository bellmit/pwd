...
public class FeedBackActivity extends BaseFragmentActivity implements OnClickListener,OnPostListenerInterface {
	...
	private EditText activity_mine_setting_feedback_content_edt;// 情书日您的宝贵意见与建议...
	...
	/** 动态添加图片 */
	private GridView gridView;// 动态添加图片
...
//					Intent intent = new Intent(FeedBackActivity.this, SelectedCoverActivity.class);
	...
	public void OnHandleResultListener(Object obj, int responseId) {
		try {
			...
			case FeedBackHandle.FEED_BACK:
				...
				if (feedBackRes != null) {
//					UiHelper.ShowOneToast(this, "意见反馈请求成功");
