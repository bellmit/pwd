package com.newland.wstdd.common.listview;
/**
 * 这个类的作用就是为了多行不会挤在一起
 */
...
public class DefineListViews extends ListView {

    public DefineListViews(Context context) {
        super(context);
    }
    public DefineListViews(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public DefineListViews(Context context, AttributeSet attrs, int defStyle) {
