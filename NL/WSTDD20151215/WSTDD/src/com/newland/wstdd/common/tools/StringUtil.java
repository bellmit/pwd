...
public class StringUtil {
	...
	public static String mess2Str(String mess) {
		...
		if (mess.equals("讲座")) {
			finalStr = "chair";
		} else if (mess.equals("团购")) {
			finalStr = "groupbuying";
		} else if (mess.equals("招聘")) {
			finalStr = "invite";
		} else if (mess.equals("聚会")) {
			finalStr = "meeting";
		} else if (mess.equals("旅行")) {
			finalStr = "travel";
		} else if (mess.equals("众筹")) {
			finalStr = "crowdfunding";
		} else if (mess.equals("投票")) {
			finalStr = "vote";
		} else if (mess.equals("全部")) {
			finalStr = "all";
		}
		return finalStr;
	}
