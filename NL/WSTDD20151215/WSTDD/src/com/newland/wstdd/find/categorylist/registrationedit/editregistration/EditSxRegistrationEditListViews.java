...
public class EditSxRegistrationEditListViews extends ListView {

    public EditSxRegistrationEditListViews(Context context) {
        super(context);
    }
    public EditSxRegistrationEditListViews(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public EditSxRegistrationEditListViews(Context context, AttributeSet attrs, int defStyle) {
