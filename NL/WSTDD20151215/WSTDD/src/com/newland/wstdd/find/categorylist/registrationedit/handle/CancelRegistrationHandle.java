 ...
 *
 */
public class CancelRegistrationHandle extends Handler {
	public static final int CANCEL_REGISTRATION = 0;//发现热门活动
	private RegistrationSubmitActivity context;
	public CancelRegistrationHandle(RegistrationSubmitActivity context) {
