 ...
 * 
 */
public class SxRegistrationEditAdapter extends BaseAdapter {
	private LayoutInflater mInflater;
	SxRegistrationEditAdapterData data ;
	private Context context;
    private	SxRegistrationEditChildAdapter adapter;
	private List<SxRegistrationEditAdapterData> registrationData;// 数据
	 private boolean showRl1=true;//第一个rl布局需要显示出来 姓名 手机号 删除
	private boolean showRl2 = true;// 第二个rl布局需要显示出来 编辑信息 完成 
	public SxRegistrationEditAdapter(Context context,
	...
	@Override
	public SxRegistrationEditAdapterData getItem(int position) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(
					R.layout.registration_edit_listview_item, parent, false);// 这里有区别？？？
			holder.name = (TextView) convertView
					.findViewById(R.id.registration_edit_sxtop_name);
			holder.phone = (TextView) convertView
					.findViewById(R.id.registration_edit_sxtop_phone);
			holder.delete = (TextView) convertView
					.findViewById(R.id.registration_edit_sxtop_delete);
			holder.edit = (TextView) convertView
					.findViewById(R.id.registration_edit_sxtop_edit);
			holder.listView = (SxRegistrationEditListViews) convertView
					.findViewById(R.id.registration_sx_listview);
			holder.rl1 = (RelativeLayout) convertView
					.findViewById(R.id.registration_edit_listview_item_toprl1);
			holder.rl2 = (RelativeLayout) convertView
					.findViewById(R.id.registration_edit_listview_item_toprl2);
		...
		adapter = new SxRegistrationEditChildAdapter(
				context, registrationData, position);
		...
		holder.edit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				registrationData.get(position).setMap(maps);
				String nameString = null;
				String phoneString = null;
				List<Map<String, String>> values = registrationData.get(position).getMap();
	...
	class ViewHolder {
		...
		public SxRegistrationEditListViews listView;// 动态添加
		// 需要进行显示隐藏的
