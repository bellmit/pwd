...
public class SxRegistrationEditListViews extends ListView {

    public SxRegistrationEditListViews(Context context) {
        super(context);
    }
    public SxRegistrationEditListViews(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public SxRegistrationEditListViews(Context context, AttributeSet attrs, int defStyle) {
