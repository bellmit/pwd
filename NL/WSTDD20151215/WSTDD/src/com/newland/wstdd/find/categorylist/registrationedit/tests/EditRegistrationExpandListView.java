...
public class EditRegistrationExpandListView extends ExpandableListView {

    public EditRegistrationExpandListView(Context context) {
        super(context);
    }
    public EditRegistrationExpandListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public EditRegistrationExpandListView(Context context, AttributeSet attrs, int defStyle) {
