...
public class AboutTddActivity extends BaseFragmentActivity implements OnPostListenerInterface,OnClickListener {
	...
	private void showDownLoadDialog(final String updateUrl) {
		try {
			...
			AlertDialog dialog = new AlertDialog.Builder(this).setMessage("有最新版本,是否更新？").setPositiveButton("立即去更新", new android.content.DialogInterface.OnClickListener() {
	...
	private void doDownLoadWork(String strurl) {
		try {
			...
			httpHandler = fh.download(strurl, new AjaxParams(), AppContext.CASH_DIR_APK + fileName, false, new AjaxCallBack() {
	...
	public void installApk(String fileName) {
		...
		// String fileName = AppContext.CASH_DIR_APK + str;
	...
	public void getLocalVersion() {
		...
		appContext.setVersionCode(strVersionCode);
	}
	...
	public void initView() {
		...
		relativelayout1.getLayoutParams().height = appContext.getScreenHeight()/3-30;
		linearlayout2.getLayoutParams().height = appContext.getScreenHeight()/3;
		relativelayout.getLayoutParams().height = appContext.getScreenHeight()/3;
