...
public class SelectInterestActivity extends BaseFragmentActivity implements OnPostListenerInterface{
	...
	private List<TddUserTagQuery> myTags=new ArrayList<TddUserTagQuery>();//选择的兴趣标签 这个是要返回给上一页的数据，通过StartActivity的方式
	...
	public void OnHandleResultListener(Object obj, int responseId) {
		...
		case SelectInterestHandle.SELECT_INTEREST:
			...
			if(myInterestTagsRes!=null){
				  //发送广播  更新界面
//	             Intent intent0 =getIntent();//切记  这里的Action参数与IntentFilter添加的Action要一样才可以
...
//	 	    	 sendBroadcast(intent0);//发送广播了
				...
				//根据返回的结果进行相应的处理
	             ...
	             appContext.setTags(tagNamesList);
	                //关闭Activity
