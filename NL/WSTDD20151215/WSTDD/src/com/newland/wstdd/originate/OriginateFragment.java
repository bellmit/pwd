 ...
 * 
 */
public class OriginateFragment extends Fragment implements OnClickListener,OnPostListenerInterface {
	...
	private List<TddAdvCfgVo> adsList = new ArrayList<TddAdvCfgVo>();//广告首页对应的 对象集合
...
//			setLoginSignInDialog();
	...
	private void initGenernalView() {
		...
		if (mOriginate_genernal_btn5 != null) {
			...
			mOriginate_genernal_btn5.setText("讲座");
...
//			popupWindow.showAsDropDown(v);
		 ...
		 * 通用模板
		 */
		case R.id.originate_genernal_ll:// 团购
			break;
