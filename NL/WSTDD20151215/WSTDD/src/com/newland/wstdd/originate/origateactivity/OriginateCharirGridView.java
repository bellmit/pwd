...
public class OriginateCharirGridView extends GridView {

    public OriginateCharirGridView(Context context) {
    ...
    public OriginateCharirGridView(Context context, AttributeSet attrs) {
    ...
    public OriginateCharirGridView(Context context, AttributeSet attrs, int defStyle) {
